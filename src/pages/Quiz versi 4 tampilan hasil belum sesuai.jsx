...
const GLOBAL_CSS = `
  ...
  *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .qv3-prodi-info-label span { font-size: 0.75rem; }
  .qv3-label-belajar { color: #22d3ee; }
  .qv3-label-karier  { color: #34d399; }
  .qv3-label-cocok   { color: #fbbf24; }
  .qv3-prodi-info-list { display: flex; flex-wrap: wrap; gap: 4px; }
  .qv3-info-chip {
    padding: 4px 10px; border-radius: 100px; font-size: 0.6rem; font-weight: 600;
    background: #131729; color: #cbd5e1; border: 1px solid #2a3055;
  }
  .qv3-cocok-text {
    font-size: 0.72rem; color: #cbd5e1; line-height: 1.5;
    padding: 6px 10px; background: #131729; border-radius: 8px;
    border-left: 3px solid #fbbf24; font-style: italic;
  }
